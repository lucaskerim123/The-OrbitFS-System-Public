...
- Write panel port, system drive, OrbitFS Engine/MCP URL, sorter URL, licence URL, Windows service names, and service folders into the installed environment configuration while keeping every value editable afterward from the admin panel.
